...
driver.get("file:///C:/Users/Domo/Desktop/selenium/Waits.html")	

driver.find_element_by_id("clickOnMe").click()
wait.until(expected_conditions.visibility_of_element_located((By.TAG_NAME, "p")))			#zaimportować,   widocznosc elementu zlokalizowanego, oczekujemy na widocznosc tagu 'p'	+ import By
